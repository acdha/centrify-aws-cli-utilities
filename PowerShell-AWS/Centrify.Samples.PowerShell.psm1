...
function Centrify-Elevate($token, $challenge, $elevate, $username) {
    ...
    $restResult = Centrify-InvokeREST -Endpoint $token.Endpoint -Method "/security/startchallenge" -Token $bearerToken  -ObjectContent $restArg
	$global:myresult1 = $restResult
	#-IncludeSessionInResult $true
...
Export-ModuleMember -function Centrify-Elevate
